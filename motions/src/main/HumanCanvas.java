...
public class HumanCanvas extends GLCanvas implements GLEventListener, MouseListener, KeyListener {
	...
	private HashMap<String, AWTMouseAdapter> mouseAdapters;
	private AWTMouseAdapter currentAdapter = null;
	...
	public HumanCanvas() {
		...
		this.mouseAdapters = new HashMap<String, AWTMouseAdapter>();
		this.mouseAdapters.put("Create motion", new AWTMouseAdapter(new CreateMotionMouseAdapter()));
		this.mouseAdapters.put("Create timeline", new AWTMouseAdapter(new CreateTimelineMouseAdapter()));
	}
	...
	public AWTMouseAdapter getCurrentAdapter() { return currentAdapter; }

	public void setCurrentAdapter(AWTMouseAdapter currentAdapter) { this.currentAdapter = currentAdapter; }
	
	public void setMouseAdapter(String name) {
		if(getCurrentAdapter() != null) currentAdapter.removeFrom(this);
		mouseAdapters.get(name).addTo(this);
		setCurrentAdapter(mouseAdapters.get(name));
	}

	public class CreateMotionMouseAdapter extends MouseAdapter {
		@Override
		public void mouseClicked(MouseEvent e) {
			System.out.println("CreateMotionMouseAdapter");
		}
		
		@Override
		public void mouseDragged(MouseEvent e) { System.out.println(e.getX());}
	}
	
	public class CreateTimelineMouseAdapter extends MouseAdapter {
		@Override
		public void mouseClicked(MouseEvent e) {
